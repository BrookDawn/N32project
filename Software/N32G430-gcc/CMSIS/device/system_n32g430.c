...
const uint32_t const_data1[2] __attribute__((section(".ARM.__at_0x08002118"))) = {0, 0};
const uint32_t const_data2[2] __attribute__((section(".ARM.__at_0x08002918"))) = {0, 0};
...
void Get_NVR_Value(uint32_t addr, uint32_t* value)
{
    ...
    get_nvr(addr, value);
    /* Remove problematic const_data1 and const_data2 access */
    /* data = const_data1[0]; */
    /* data = const_data2[0]; */
    if(data)
    {/* avoid warning*/
