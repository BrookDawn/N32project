...
#define MODBUS_SLAVE_INPUT_REG_COUNT     32U
#define MODBUS_SLAVE_COIL_START          0x0000U
#define MODBUS_SLAVE_COIL_COUNT          32U
#define MODBUS_SLAVE_DISCRETE_START      0x0000U
#define MODBUS_SLAVE_DISCRETE_COUNT      32U

/* 帧缓冲区大小 */
#define MODBUS_SLAVE_RX_BUFFER_SIZE      128U
#define MODBUS_SLAVE_TX_BUFFER_SIZE      128U
