...
/* 日志环形缓冲区大小 */
#define LOG_RING_BUFFER_SIZE         256

/* USART1 DMA配置 (用于Modbus从机或异步Log) */
...
#define USART1_RX_DMA_BUFFER_SIZE    128
...
#define USART2_TX_DMA_BUFFER_SIZE    32
